...
assert.equal(revealable("sideband://result", { resultLocation: "file://server/share/todo-app.mjs" }), false, "explicit remote file-URI locations must not advertise a local Show result action");
